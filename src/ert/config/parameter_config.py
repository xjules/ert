...
class ParameterCardinality(StrEnum):
    """
    one_param_config_per_ensemble_dataset: one config instance per single param, one
    dataset per ensemble

    multiple_configs_per_ensemble_dataset: one config instance per group, one
    dataset per ensemble

    one_param_config_per_realization_dataset: one config instance per group, one
    dataset per realization
    """

    one_param_config_per_ensemble_dataset = auto()
    multiple_configs_per_ensemble_dataset = auto()
    one_param_config_per_realization_dataset = auto()
